...
import { auth } from "@/lib/firebase"; // 🚀 Absolute Path
// import { useAuth } from "@/app/context/AuthContext"; // 🚀 Vercel Error Fixed (Absolute Path - uncomment if needed)
...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#ffffff] flex flex-col justify-center overflow-hidden font-sans">
      ...
      {/* 🚀 EXACT TECHFLOW VIBRANT WAVE GRADIENT */}
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .techflow-wave {
          ...
          height: 100vh;
          background-image: 
            radial-gradient(ellipse at 80% 20%, rgba(66, 209, 245, 0.45) 0%, transparent 40%),
        ...
        .techflow-shadow {
          box-shadow: 0 30px 60px -15px rgba(0, 0, 0, 0.1), 0 0 20px rgba(0,0,0,0.02);
        }
        .text-super-tight {
      ...
      {/* Background Layer */}
      <div className="techflow-bg">
         <div className="techflow-wave"></div>
      </div>
      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-[440px] px-6 lg:px-0 py-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-3 text-center text-[16px] text-[#555] font-medium">
            Register your school and get started today
          </p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-2xl py-8 px-6 sm:px-10 border border-white/60 rounded-[20px] techflow-shadow">
          ...
          <form className="space-y-5" onSubmit={handleSignup}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 border border-gray-200 rounded-[10px] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#111] text-[15px] font-medium bg-white/50 transition-all shadow-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 py-3.5 px-4 border border-transparent rounded-[10px] shadow-lg text-[15px] font-bold text-white bg-[#0b0b0b] hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-all disabled:opacity-70 mt-4"
            >
          ...
          <div className="mt-6 text-center">
            <span className="text-[13.5px] text-[#555] font-medium">
              Already have an account?{" "}
            </span>
            <Link href="/login" className="font-bold text-[#111] hover:text-black text-[13.5px] hover:underline">
              Sign in
            </Link>
          </div>
