...
export default function ResultPage() {
  ...
  return (
    <div className="animate-fade-in pb-20 print:pb-0 print:bg-white">
      ...
      {selectedResult && (
        <div id="print-overlay" className="fixed inset-0 z-[99999] flex items-start justify-center bg-black/80 backdrop-blur-sm overflow-y-auto p-4 sm:p-8">
          
          <div id="print-content" className="bg-white rounded-3xl w-full max-w-3xl shadow-2xl relative my-auto p-6 sm:p-10">
            
            {/* Modal Controls (Hidden in Print via CSS class) */}
            <div className="print-hidden-btns flex justify-end gap-3 mb-6 border-b border-slate-100 pb-4">
            ...
            <div className="w-full mx-auto">
              ...
              {/* School Header */}
              <div className="flex justify-between items-center border-b-[3px] border-black pb-4 mb-4 mt-0">
              ...
              {/* Grading Summary */}
              <div className="flex justify-between items-center bg-gray-50 p-4 border-2 border-black rounded-xl" id="print-grading-box">
              ...
              <div className="mt-6 text-center text-[9px] text-gray-400 uppercase tracking-widest font-bold hidden" id="print-footer">System Generated Report Card - Aligned with IBCC 2026 Standards</div>
            </div>
          </div>
        </div>
      )}

      {/* --- THE 100% BULLETPROOF CSS PRINT FIX --- */}
      <style jsx global>{`
        @media print {
          ...
          /* Show ONLY the overlay and its children */
          ...
          /* Hide the buttons */
          .print-hidden-btns, .print-hidden-btns * {
            display: none !important;
            visibility: hidden !important;
          }

          /* Show the footer and remove border-radius from grading box */
          #print-footer {
