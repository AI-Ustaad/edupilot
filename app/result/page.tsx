...
export default function ResultPage() {
  ...
  return (
    <div className="animate-fade-in space-y-6 pb-20 print:space-y-0 print:pb-0">
      ...
      {selectedResult && (
        <div id="print-overlay" className="fixed inset-0 z-[99999] bg-black/80 backdrop-blur-sm overflow-y-auto print:overflow-hidden print:bg-white print:fixed print:p-0">
          
          <div className="min-h-screen flex items-start justify-center p-4 sm:p-8 print:p-0 print:block print:w-full print:h-full">
            
            <div className="bg-white rounded-3xl w-full max-w-3xl shadow-2xl relative mt-4 mb-4 sm:mt-10 sm:mb-10 p-6 sm:p-10 print:m-0 print:p-[15mm] print:rounded-none print:shadow-none print:border-none print:w-full print:h-full print:box-border">
              ...
              <div className="print:w-full print:mx-auto">
                ...
                {/* School Header with Logo (Compacted margins) */}
                <div className="flex justify-between items-center border-b-2 border-black pb-4 mb-4 mt-0">
                ...
                {/* Student Info & Photo Layout (Compacted margins) */}
                ...
                {/* Grading Summary (Compacted Margin) */}
                <div className="flex justify-between items-center bg-gray-50 p-4 border-2 border-black rounded-xl print:rounded-none">
                ...
                <div className="mt-6 text-center text-[9px] text-gray-400 uppercase tracking-widest font-bold print:block hidden">System Generated Report Card - Aligned with IBCC 2026 Standards</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx global>{`
        @media print {
          /* 1. Hide the entire normal app */
          body > *:not(#print-overlay) {
            display: none !important;
          }
          
          /* 2. Remove all body margins/paddings */
          body, html {
            margin: 0 !important;
            padding: 0 !important;
          ...
          /* 3. Take the print overlay and make it the ONLY thing on the page */
          #print-overlay {
          ...
          /* 4. Force A4 Size and ZERO browser margins */
          @page {
            size: A4 portrait;
