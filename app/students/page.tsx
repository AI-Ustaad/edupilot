...
// CNIC کو آٹو فارمیٹ کرنے کا فنکشن
...
export default function StudentsPage() {
  ...
  // یہ وہ formData ہے جو Vercel کو نہیں مل رہا تھا!
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (file.size > 500 * 1024) return setErrorMsg("Image is too large! Please select an image under 500KB.");
      setErrorMsg("");
      try {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
          ...
          <form onSubmit={handleSaveStudent} className="space-y-8">
            ...
            {/* --- نیا اور بہترین سکول پلیسمنٹ سیکشن (Dropdowns کے ساتھ) --- */}
            <section>
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0 pr-12">
                       ...
                       <p className="text-[11px] text-slate-500 truncate mt-0.5">
                         Roll: {student.rollNumber} • {student.classGrade} {student.section && `- ${student.section}`}
                       </p>
                     </div>
