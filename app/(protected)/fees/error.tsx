...
export default function FeesError({
  ...
  useEffect(() => {
    console.error("Fees Module Error:", error);
  }, [error]);
  ...
  return (
    <div className="flex h-[70vh] flex-col items-center justify-center text-center p-8">
      <div className="bg-white border border-gray-200 rounded-3xl p-10 max-w-md shadow-sm">
        ...
        <h2 className="text-xl font-black text-gray-900 mb-2">Fee Management Failed</h2>
        <p className="text-gray-500 mb-6 text-sm">
          We couldn&apos;t load the fee ledger. Please check your connection or try again.
        </p>
