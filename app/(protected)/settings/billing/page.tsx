...
export default function BillingPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-black mb-6">Subscription & Billing</h1>
      <div className="grid md:grid-cols-4 gap-4">
        {Object.values(PLANS).map(plan => (
          <div key={plan.id} className="bg-white rounded-xl shadow p-4 border">
            <h3 className="text-xl font-bold">{plan.name}</h3>
            <p className="text-2xl font-black mt-2">${plan.price}/mo</p>
            <p className="text-sm text-slate-500 mt-2">Up to {plan.limits.students} students</p>
            <button
