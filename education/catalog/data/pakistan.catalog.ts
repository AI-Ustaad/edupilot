...
export const PAKISTAN_CATALOG: Country = {
  ...
  // @ts-ignore - Ignoring for simplified hierarchical seed data
  authorities: [
    {
      id: "punjab_gov",
              ...
              levels: [
                {
                  ...
                  grades: [
                    {
                      id: "grade_1", name: "Grade 1", order: 1,
                      schemeOfStudy: {
                        subjects: [
                    ...
                    {
                      id: "grade_5", name: "Grade 5", order: 5,
                      schemeOfStudy: {
                        subjects: [
                          { subjectId: "eng", category: "Compulsory", defaultPeriods: 6 },
                          { subjectId: "urd", category: "Compulsory", defaultPeriods: 6 },
                ...
                },
                {
                  ...
                  grades: [
                    {
                      id: "grade_9", name: "Grade 9", order: 9,
                      schemeOfStudy: {
                        subjects: [
                          { subjectId: "eng", category: "Compulsory", defaultPeriods: 6 },
                          { subjectId: "urd", category: "Compulsory", defaultPeriods: 6 },
              ...
              levels: [
                {
                  ...
                  grades: [
                    {
                      id: "year_10", name: "Year 10", order: 10,
                      schemeOfStudy: {
                        subjects: [
